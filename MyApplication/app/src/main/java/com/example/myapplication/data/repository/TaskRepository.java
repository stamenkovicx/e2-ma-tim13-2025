...
public interface TaskRepository {
    ...
    void getCompletedTasksCountByCategory(String userId, OnStatisticsLoadedListener<Map<String, Pair<Integer, Integer>>> listener);    void getAverageDifficultyXp(String userId, OnStatisticsLoadedListener<Double> listener);
