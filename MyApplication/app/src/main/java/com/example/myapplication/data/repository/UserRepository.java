...
public interface UserRepository {
    ...
    void applyDailyMessageBonus(String allianceId, String userId, OnCompleteListener<Void> listener);

    interface MissionProgressListener<T> {
        void onProgressChange(T result);
        void onFailure(Exception e);
    }
    ListenerRegistration observeMissionProgress(
            String allianceId,
            List<String> userIds,
