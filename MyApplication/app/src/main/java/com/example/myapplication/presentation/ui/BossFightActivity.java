...
public class BossFightActivity extends AppCompatActivity {
    ...
    private void showEquipmentDialog() {
        new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                .setMessage("Do you want to activate equipment before the fight?")
                .setCancelable(false)
                .setPositiveButton("Yas", (dialog, which) -> startActivity(new Intent(BossFightActivity.this, InventoryActivity.class)))
